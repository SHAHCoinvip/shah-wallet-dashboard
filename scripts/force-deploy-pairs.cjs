...
async function main() {
    console.log("🔧 Force Deploying Pairs + Adding Liquidity + Oracle Registration...\n");
    ...
    try {
        ...
        // Step 1: Try to add liquidity directly to existing pair addresses
        console.log("💧 Step 1: Attempting to add liquidity to existing pair addresses...\n");
        ...
        // Try to add liquidity to each pair
        for (const [pairName, pairAddress] of Object.entries(EXPECTED_PAIR_ADDRESSES)) {
        ...
        // Summary
        console.log("🎉 Force Liquidity Addition + Oracle Registration Complete!\n");
        ...
        fs.writeFileSync(
            path.join(__dirname, "..", "force-liquidity-results.json"),
            JSON.stringify(results, null, 2)
        );

        console.log("\n💾 Results saved to: force-liquidity-results.json");
